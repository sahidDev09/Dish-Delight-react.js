...
const SingleCard = ({ cardData, handleCookbtn}) => {
  ...
  return (
    <div className=" border border-gray-300 p-5 rounded-md mb-5 md:mb-0">
      <img
      ...
      <button onClick={()=>handleCookbtn(cardData)} className="btn btn-success text-white rounded-full my-5 flex">
        Want to Cook
      </button>
    </div>
  );
